...
from backend.services.quantum_solver import QuantumSolverService
from backend.tasks.solver_tasks import classical_solve_task # Import classical solver for fallback
